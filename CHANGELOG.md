...
## <small>1.4.6 (2025-10-15)</small>

* build: migrate to esm ([a76bf65](https://github.com/JorgeLNJunior/render-deploy/commit/a76bf65))
* build: package all files ([adfbf9f](https://github.com/JorgeLNJunior/render-deploy/commit/adfbf9f))
* build: package all files ([83117e0](https://github.com/JorgeLNJunior/render-deploy/commit/83117e0))
* build(deps): update dependencies ([d9f18e7](https://github.com/JorgeLNJunior/render-deploy/commit/d9f18e7))
* chore: add `pre_deploy_failed` status to possible failure states ([b3cb6a9](https://github.com/JorgeLNJunior/render-deploy/commit/b3cb6a9))
* chore: add debug messages ([00101e3](https://github.com/JorgeLNJunior/render-deploy/commit/00101e3))
* chore: change eslint's file extension to .js ([d101aaf](https://github.com/JorgeLNJunior/render-deploy/commit/d101aaf))
* chore: fix codeowners file ([2655c52](https://github.com/JorgeLNJunior/render-deploy/commit/2655c52))
* chore: mock `wait` in tests to speed them up ([9ef18d7](https://github.com/JorgeLNJunior/render-deploy/commit/9ef18d7))
* chore: package all files ([8700160](https://github.com/JorgeLNJunior/render-deploy/commit/8700160))
* chore: update the codeowners file ([bc48cb1](https://github.com/JorgeLNJunior/render-deploy/commit/bc48cb1))
* chore: upload render's logo [skip ci] ([6820c06](https://github.com/JorgeLNJunior/render-deploy/commit/6820c06))
* chore(release): change the commit message ([bf49566](https://github.com/JorgeLNJunior/render-deploy/commit/bf49566))
* chore(release): v1.4.5 ([e3b8ad5](https://github.com/JorgeLNJunior/render-deploy/commit/e3b8ad5))
* docs: fix readme logo ([b71bb81](https://github.com/JorgeLNJunior/render-deploy/commit/b71bb81))
* docs(readme): add a logo ([43e66f7](https://github.com/JorgeLNJunior/render-deploy/commit/43e66f7))
* docs(readme): remove the unnecessary checkout action ([a8f27b7](https://github.com/JorgeLNJunior/render-deploy/commit/a8f27b7))
* docs(readme): rewrite the README file ([64b98eb](https://github.com/JorgeLNJunior/render-deploy/commit/64b98eb))
* docs(readme): update version in examples [skip ci] ([1cfd744](https://github.com/JorgeLNJunior/render-deploy/commit/1cfd744))
* ci: do not update develop branch ([e1ed284](https://github.com/JorgeLNJunior/render-deploy/commit/e1ed284))
* ci(actions): extract release into a standalone workflow ([47e82d5](https://github.com/JorgeLNJunior/render-deploy/commit/47e82d5))
* ci(actions): run CI only in the main branch ([f9f8b40](https://github.com/JorgeLNJunior/render-deploy/commit/f9f8b40))
* ci(actions): upgrade dependencies ([3807acd](https://github.com/JorgeLNJunior/render-deploy/commit/3807acd))
* ci(codeql): upgrade codeql dependencies ([a631cd8](https://github.com/JorgeLNJunior/render-deploy/commit/a631cd8))
* ci(fix): update changelog template url ([b0cd0dd](https://github.com/JorgeLNJunior/render-deploy/commit/b0cd0dd))
* ci(release): identify the author ([f7d76ab](https://github.com/JorgeLNJunior/render-deploy/commit/f7d76ab))
* test: replace jest by vitest ([a2e3b2f](https://github.com/JorgeLNJunior/render-deploy/commit/a2e3b2f))
* style: migrate to eslint v9 ([da80f33](https://github.com/JorgeLNJunior/render-deploy/commit/da80f33))
* style: remove prettier ([81ae72c](https://github.com/JorgeLNJunior/render-deploy/commit/81ae72c))
...
- chore: add debug messages [`00101e3`](https://github.com/JorgeLNJunior/render-deploy/commit/00101e359c42d0f097101b90f8012788578a760d)
- chore: mock `wait` in tests to speed them up [`9ef18d7`](https://github.com/JorgeLNJunior/render-deploy/commit/9ef18d77b514c3302bcc2ae4d20de0999cd96a82)
- docs(readme): remove the unnecessary checkout action [`a8f27b7`](https://github.com/JorgeLNJunior/render-deploy/commit/a8f27b7e491b8a6d1e487f187857279305bdeabb)
- docs: fix readme logo [`b71bb81`](https://github.com/JorgeLNJunior/render-deploy/commit/b71bb81da32052fd4efc036a5d64951875ed74ce)
- build: package all files [`adfbf9f`](https://github.com/JorgeLNJunior/render-deploy/commit/adfbf9fec6759a8df35583db4a076b5d87e53bc4)
- chore: upload render's logo [skip ci] [`6820c06`](https://github.com/JorgeLNJunior/render-deploy/commit/6820c06d98e3efbb8bb6b9fb7c097b741367e3ef)
...
- docs(readme): rewrite the README file [`64b98eb`](https://github.com/JorgeLNJunior/render-deploy/commit/64b98ebb32425203c45e492ecae734190f4dfc72)
- chore(release): v1.4.5 [`9978fcd`](https://github.com/JorgeLNJunior/render-deploy/commit/9978fcd7ae237039fc3337c47ac2e1018d693df3)
- ci(actions): extract release into a standalone workflow [`47e82d5`](https://github.com/JorgeLNJunior/render-deploy/commit/47e82d597d586f61a7735790bd64fe38e7647013)
- ci: do not update develop branch [`e1ed284`](https://github.com/JorgeLNJunior/render-deploy/commit/e1ed284946a2c56784b31c567d355bb116f906a6)
- ci(actions): upgrade dependencies [`3807acd`](https://github.com/JorgeLNJunior/render-deploy/commit/3807acdac2b483ebca3dce1fc8ea44906259f1e5)
- style: remove prettier [`81ae72c`](https://github.com/JorgeLNJunior/render-deploy/commit/81ae72c957349a0d8f16c7dff5ca6c5408eeb867)
- ci(codeql): upgrade codeql dependencies [`a631cd8`](https://github.com/JorgeLNJunior/render-deploy/commit/a631cd84fb0c87433dd8abaa4b3c68645d5d45c0)
- docs(readme): update version in examples [skip ci] [`1cfd744`](https://github.com/JorgeLNJunior/render-deploy/commit/1cfd744f1026afd4df060aeb64bdb6483cd8e11f)
- ci(release): identify the author [`f7d76ab`](https://github.com/JorgeLNJunior/render-deploy/commit/f7d76abf0caef256a6b97e198acaf6f6c897d164)
- ci(actions): run CI only in the main branch [`f9f8b40`](https://github.com/JorgeLNJunior/render-deploy/commit/f9f8b40ff665aa1e9034649fa09cd846f688e688)
- docs(readme): add a logo [`43e66f7`](https://github.com/JorgeLNJunior/render-deploy/commit/43e66f7d06756ca6d1ebd8f523f67d532a19b8a3)
- chore(release): change the commit message [`bf49566`](https://github.com/JorgeLNJunior/render-deploy/commit/bf4956688d97966e72c6ce54651431abc0d40397)
- chore: fix codeowners file [`2655c52`](https://github.com/JorgeLNJunior/render-deploy/commit/2655c52c76f27c8fd2bbe9ee7541b7f38f02d5b5)
- chore: update the codeowners file [`bc48cb1`](https://github.com/JorgeLNJunior/render-deploy/commit/bc48cb19d1419eea4481be22bcf8765bb060897b)
- ci(fix): update changelog template url [`b0cd0dd`](https://github.com/JorgeLNJunior/render-deploy/commit/b0cd0dd8586ff5866093a736ab6cd6cfda4a81b5)
- chore: package all files [`8700160`](https://github.com/JorgeLNJunior/render-deploy/commit/8700160bb3fdfaad0b314236c44cd24beaf64a8f)
- chore: change eslint's file extension to .js [`d101aaf`](https://github.com/JorgeLNJunior/render-deploy/commit/d101aafd8420dff6fe01287bfdbb01755249410e)
- build: package all files [`83117e0`](https://github.com/JorgeLNJunior/render-deploy/commit/83117e0ef2135cd1c6ecf9d17c6fb5f8911f68ea)
...
- build(deps): update dependencies [`5e28134`](https://github.com/JorgeLNJunior/render-deploy/commit/5e28134e825f9bcfdb86618a271ff404ff2f0270)
- chore: bump v1.4.4 [`2b145ca`](https://github.com/JorgeLNJunior/render-deploy/commit/2b145ca262c3625c8f556cf17c17c12d4e7dc269)
- ci(deps): downgrade node version [`2e1b8d3`](https://github.com/JorgeLNJunior/render-deploy/commit/2e1b8d3a9d410f0bc5227c86c5b724e28204d5f4)
- docs: revert version [`9615eb6`](https://github.com/JorgeLNJunior/render-deploy/commit/9615eb612d90d016d8b3996cb8580c74ec030d7e)
- docs: fix the instructions text [`d5233d8`](https://github.com/JorgeLNJunior/render-deploy/commit/d5233d88f1bae397e8e95daee8c298f8142a2b30)
- test: fix some mocks [`7ddadc8`](https://github.com/JorgeLNJunior/render-deploy/commit/7ddadc88320b66a60685ab3f9b49cc6c833c7b49)
- build: package all files [`9dd9560`](https://github.com/JorgeLNJunior/render-deploy/commit/9dd9560cfbfa4e3f407d39c6a2a0eb412a3fb29a)
